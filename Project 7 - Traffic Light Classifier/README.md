...
Python Program calls a traffic image of varying sizes, crops the image, determines if traffic light is red, yellow or green with greater than 90% accuracy!

Project Overview Traffic Light Classifier
